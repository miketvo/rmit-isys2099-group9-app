...
const createProductAttributeWithCategories = async (req, res) => {
  try {
    ...
    console.log(
      `attribute_name: ${attribute_name}, attribute_type: ${attribute_type}, required: ${required}, categories: ${categories}`,
    );
    ...
    res
      .status(500)
      .send(
        "An error occurred while creating a product attribute and associating it with categories",
      );
  }
};
...
const updateProductAttributeWithCategories = async (req, res) => {
  try {
    ...
    console.log(
      `attribute_name: ${attribute_name}, new_attribute_name: ${new_attribute_name}, categories: ${categories}`,
    );
    ...
    console.log(
      `Updated attribute name from ${attribute_name} to ${new_attribute_name}`,
    );
    ...
    res
      .status(500)
      .send(
        "An error occurred while updating a product attribute and associating it with categories",
      );
  }
};
