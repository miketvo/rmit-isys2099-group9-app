...
VALUES (1, "http://localhost:3000/uploads/1.jpg", 'Smartphone Model X', 'High-end smartphone with top-notch features.', 'Mobiles', 899.99, 6, 12, 1, 'loi'),
       (2, "http://localhost:3000/uploads/2.jpg", 'Gaming Laptop Pro', 'Powerful gaming laptop for enthusiasts.', 'Computer', 1499.99, 35, 25, 2, 'loi'),
       ...
       (11, "http://localhost:3000/uploads/11.jpg", 'High-Performance Desktop PC', 'Custom-built desktop PC for gaming and heavy tasks.', 'Computer', 2499.99, 45, 50, 25, 'mike'),
       ...
       (16, "http://localhost:3000/uploads/16.jpg", 'Low-Performance Desktop PC', 'Custom-built desktop potato.', 'Computer', 2499.99, 45, 50, 25, 'mike'),
