...
VALUES (1, "http://localhost:3000/uploads/1.jpg", 'Smartphone Model X', 'High-end smartphone with top-notch features.', 'Mobiles', 899.99, 6, 12, 1, 'loi'),
       (2, "http://localhost:3000/uploads/2.jpg", 'Gaming Laptop Pro', 'Powerful gaming laptop for enthusiasts.', 'Computers', 1499.99, 35, 25, 2, 'loi'),
       (3, "http://localhost:3000/uploads/3.jpg", 'RGB Mechanical Keyboard', 'Mechanical keyboard with customizable RGB lighting.', 'Mechanical Keyboards', 89.99, 44, 14, 4, 'loi'),
       (4, "http://localhost:3000/uploads/4.jpg", 'Membrane Keyboard', 'Standard membrane keyboard for daily use.', 'Keyboards', 39.99, 42, 15, 3, 'loi'),
       (5, "http://localhost:3000/uploads/5.jpg", '27-inch Gaming Monitor', 'High-refresh rate gaming monitor for smooth gameplay.', 'Monitors', 399.99, 60, 33, 5, 'loi'),
       (6, "http://localhost:3000/uploads/6.jpg", 'Wireless Bluetooth Speaker', 'Portable speaker with long battery life.', 'Speaker', 49.99, 12, 8, 8, 'loi'),
       (7, "http://localhost:3000/uploads/7.jpg", 'Noise-Cancelling Headphones', 'Over-ear headphones with active noise cancellation.', 'Headphones', 199.99, 18, 15, 25, 'loi'),
       (8, "http://localhost:3000/uploads/8.jpg", 'Smart LED TV', 'High-definition smart TV with various features.', 'Televisions', 799.99, 48, 28, 3, 'loi'),
       (9, "http://localhost:3000/uploads/9.jpg", 'Compact Refrigerator', 'Small refrigerator for dorm rooms and offices.', 'Small Appliances', 179.99, 20, 18, 33, 'loi'),
       (10, "http://localhost:3000/uploads/10.jpg", 'Front-Load Washing Machine', 'Energy-efficient washing machine with multiple programs.', 'Large Appliances', 599.99, 30, 27, 39, 'loi'),
       (11, "http://localhost:3000/uploads/11.jpg", 'High-Performance Desktop PC', 'Custom-built desktop PC for gaming and heavy tasks.', 'Computers', 2499.99, 45, 50, 25, 'mike'),
       (12, "http://localhost:3000/uploads/12.jpg", 'Ultra-Narrow Curved Monitor', 'Curved narrow monitor for disruptive viewing experience.', 'Monitors', 599.99, 80, 35, 10, 'mike'),
       (13, "http://localhost:3000/uploads/13.jpg", 'Wireless Gaming Mouse', 'Precision gaming mouse with customizable buttons.', 'Computer Mice', 69.99, 12, 7, 4, 'mike'),
       (14, "http://localhost:3000/uploads/14.jpg", 'Bluetooth Earbuds', 'True wireless earbuds with advanced audio quality.', 'Earphones', 119.99, 5, 3, 2, 'mike'),
       (15, "http://localhost:3000/uploads/15.jpg", 'Portable Air Conditioner', 'Cool down your space with this portable AC unit.', 'Small Appliances', 299.99, 18, 15, 30, 'mike'),
       (16, "http://localhost:3000/uploads/16.jpg", 'Low-Performance Desktop PC', 'Custom-built desktop potato.', 'Computers', 2499.99, 45, 50, 25, 'mike'),
       (17, "http://localhost:3000/uploads/17.jpg", 'Ultra-Wide Curved Monitor', 'Curved monitor for immersive viewing experience.', 'Monitors', 599.99, 80, 35, 10, 'mike'),
       (18, "http://localhost:3000/uploads/18.jpg", 'Wired Gaming Mouse', 'Low-precision gaming mouse with customizable buttons.', 'Computer Mice', 69.99, 12, 7, 4, 'mike'),
       (19, "http://localhost:3000/uploads/19.jpg", 'Green-toe Earbuds', 'True wireless earbuds with advanced audio quality.', 'Earphones', 119.99, 5, 3, 2, 'mike'),
       (20, "http://localhost:3000/uploads/20.jpg", 'Importable Air Conditioner', 'Cool down your space with this immovable AC unit.', 'Small Appliances', 299.99, 18, 15, 30, 'mike'),
       (21, "http://localhost:3000/uploads/21.jpg", 'Office Keyboard', 'Mechanical office keyboard with customizable lighting.', 'Keyboards', 79.99, 42, 15, 4, 'mike'),
       (22, "http://localhost:3000/uploads/22.jpg", 'Smartphone Model Y', 'Mid-range smartphone with sleek design.', 'Mobiles', 499.99, 5, 11, 1, 'mike'),
