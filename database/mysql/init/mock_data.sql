...
INSERT INTO product (id, title, product_description, category, price, width, length, height, seller)
VALUES (1, 'Smartphone Model X', 'High-end smartphone with top-notch features.', 'Mobiles', 899.99, 6, 12, 1, 'loi'),
       (2, 'Gaming Laptop Pro', 'Powerful gaming laptop for enthusiasts.', 'Computers', 1499.99, 35, 25, 2, 'loi'),
       (3, 'RGB Mechanical Keyboard', 'Mechanical keyboard with customizable RGB lighting.', 'Mechanical Keyboards', 89.99, 44, 14, 4, 'loi'),
       (4, 'Membrane Keyboard', 'Standard membrane keyboard for daily use.', 'Keyboards', 39.99, 42, 15, 3, 'loi'),
       (5, '27-inch Gaming Monitor', 'High-refresh rate gaming monitor for smooth gameplay.', 'Monitors', 399.99, 60, 33, 5, 'loi'),
       (6, 'Wireless Bluetooth Speaker', 'Portable speaker with long battery life.', 'Speaker', 49.99, 12, 8, 8, 'loi'),
       (7, 'Noise-Cancelling Headphones', 'Over-ear headphones with active noise cancellation.', 'Headphones', 199.99, 18, 15, 25, 'loi'),
       (8, 'Smart LED TV', 'High-definition smart TV with various features.', 'Televisions', 799.99, 48, 28, 3, 'loi'),
       (9, 'Compact Refrigerator', 'Small refrigerator for dorm rooms and offices.', 'Small Appliances', 179.99, 20, 18, 33, 'loi'),
       (10, 'Front-Load Washing Machine', 'Energy-efficient washing machine with multiple programs.', 'Large Appliances', 599.99, 30, 27, 39, 'loi'),
       (11, 'High-Performance Desktop PC', 'Custom-built desktop PC for gaming and heavy tasks.', 'Computers', 2499.99, 45, 50, 25, 'mike'),
       (12, 'Ultra-Narrow Curved Monitor', 'Curved narrow monitor for disruptive viewing experience.', 'Monitors', 599.99, 80, 35, 10, 'mike'),
       (13, 'Wireless Gaming Mouse', 'Precision gaming mouse with customizable buttons.', 'Computer Mice', 69.99, 12, 7, 4, 'mike'),
       (14, 'Bluetooth Earbuds', 'True wireless earbuds with advanced audio quality.', 'Earphones', 119.99, 5, 3, 2, 'mike'),
       (15, 'Portable Air Conditioner', 'Cool down your space with this portable AC unit.', 'Small Appliances', 299.99, 18, 15, 30, 'mike'),
       (16, 'Low-Performance Desktop PC', 'Custom-built desktop potato.', 'Computers', 2499.99, 45, 50, 25, 'mike'),
       (17, 'Ultra-Wide Curved Monitor', 'Curved monitor for immersive viewing experience.', 'Monitors', 599.99, 80, 35, 10, 'mike'),
       (18, 'Wired Gaming Mouse', 'Low-precision gaming mouse with customizable buttons.', 'Computer Mice', 69.99, 12, 7, 4, 'mike'),
       (19, 'Green-toe Earbuds', 'True wireless earbuds with advanced audio quality.', 'Earphones', 119.99, 5, 3, 2, 'mike'),
       (20, 'Importable Air Conditioner', 'Cool down your space with this immovable AC unit.', 'Small Appliances', 299.99, 18, 15, 30, 'mike'),
       (21, 'Office Keyboard', 'Mechanical office keyboard with customizable lighting.', 'Keyboards', 79.99, 42, 15, 4, 'mike'),
       (22, 'Smartphone Model Y', 'Mid-range smartphone with sleek design.', 'Mobiles', 499.99, 5, 11, 1, 'mike'),
       (23, 'Noise-Boosting Over-Ear Headphones', 'Premium over-ear headphones with cutting-edge noise boosting.', 'Headphones', 249.99, 18, 16, 25, 'mike'),
       (24, 'Low Resolution Smart TV', '320p TV with mediocre visuals.', 'Televisions', 999.99, 55, 32, 5, 'mike'),
       (25, 'Robotic Vacuum Dust Depositor', 'Automated dust depositor for a dirtier than ever house.', 'Small Appliances', 149.99, 14, 14, 4, 'mike'),
       (26, 'A Cube', 'A mysterious dense 1x1x1 centimeter cube of exotic material. Where is it from? Why is it here? What is its purpose? No one knows...', 'Large Appliances', 9999.99, 1, 1, 1, 'mike');
