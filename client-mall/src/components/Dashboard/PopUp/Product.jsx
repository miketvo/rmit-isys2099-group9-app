...
const Product = ({ compData, compFunction }) => {
  ...
  useEffect(() => {
    if (edited) {
      setProductFormData(preData => ({
        ...
        product_description:
          editedProductData.product_description !== null
            ? editedProductData.product_description
            : "",
        category:
          editedProductData.category !== null ? editedProductData.category : "",
        price: editedProductData.price !== null ? editedProductData.price : "",
        width: editedProductData.width !== null ? editedProductData.width : "",
        length:
          editedProductData.length !== null ? editedProductData.length : "",
        height:
          editedProductData.height !== null ? editedProductData.height : "",
      }));
    }
  }, [
    edited,
    editedProductData.category,
    editedProductData.height,
    editedProductData.image,
    editedProductData.length,
    editedProductData.price,
    editedProductData.product_description,
    editedProductData.title,
    editedProductData.width,
  ]);
    ...
    try {
      if (created) {
        ...
        const response = await putDataAPI(
          `product/update/${editedProductData.id}`,
          productFormData,
        );
        if (response.status === 200 || response.status === 201) {
          setProductData(preData =>
  ...
  return (
    <div
      className="popup_container p-4"
      style={{ top: "-10%", width: "1050px" }}
    >
          ...
          <div className="row">
            ...
            <div className="col-5">
              <div className="d-flex flex-column mb-3">
                ...
                <div
                  className="image_container border border-secondary mt-2"
