  ...
  useEffect(() => {
    if (edited) {
        setBuyerOrderData(preData => ({
            ...preData,
            quantity: editedBuyerOrderData.quantity ? editedBuyerOrderData.quantity : "",
            product_id: editedBuyerOrderData.id ? editedBuyerOrderData.id: ""
        }))
    }
  }, [edited, editedBuyerOrderData.id, editedBuyerOrderData.product_id, editedBuyerOrderData.quantity])
      ...
      <form onSubmit={handleSubmitData}>
        <div className="container_fluid">
          <div className="row">
            ...
            <div className="col-6">
              <div className="mb-3">
                ...
                <input type="number" className="form-control"
                      name="quantity" value={quantity} onChange={handleChangeInput}
                />
              </div>
            </div>
          </div>
          <div className="submit_btn">
            ...
            <button className="btn btn-outline-primary ms-2" type="submit">Edit</button>
          </div>
        </div>
      </form>
    </div>
