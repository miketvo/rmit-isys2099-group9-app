    ...
    useEffect(() => {
        if(edited) {
            setWareHouseFormData(preData => ({
                ...preData,
                warehouse_name: editedWarehouseData.warehouse_name !== null ? editedWarehouseData.warehouse_name : "",
                volume: editedWarehouseData.volume !== null ? editedWarehouseData.volume : "",
                province: editedWarehouseData.province !== null ? editedWarehouseData.province : "",
                city: editedWarehouseData.city !== null ? editedWarehouseData.city : "",
                district: editedWarehouseData.district !== null ? editedWarehouseData.district : "",
                street: editedWarehouseData.street !== null ? editedWarehouseData.street : "",
                street_number: editedWarehouseData.street_number !== null ? editedWarehouseData.street_number : ""
            }))
        }
    }, [edited, editedWarehouseData.city, editedWarehouseData.district, editedWarehouseData.province, editedWarehouseData.street, editedWarehouseData.street_number, editedWarehouseData.volume, editedWarehouseData.warehouse_name, setWareHouseData])

    const handleChangeInput = (e) => {
        const {name, value} = e.target;
        const parsedValue = (name === "volume" || name ==="street_number") ? parseInt((value > 0 ? value : 0), 10) : value;
