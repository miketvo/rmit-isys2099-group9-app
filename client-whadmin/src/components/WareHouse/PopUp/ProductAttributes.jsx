...
const ProductAttributes = ({compData, compFunction}) => {
    ...
    useEffect(() => {
        if(edited) {
            setProductAttributeData(preData => ({
                ...
                category: editedProductAttributeData.category ? editedProductAttributeData.category : ""
            }))
        }
    }, [edited, editedProductAttributeData.attribute_name, editedProductAttributeData.attribute_type, editedProductAttributeData.category, editedProductAttributeData.required])
    ...
    const handleSubmitData = (e) => {
        e.preventDefault();
        setProductAttributesData((preData) => ([...preData, productAttributeData]))
